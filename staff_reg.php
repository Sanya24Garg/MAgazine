...
if($STAFF=="")
  {
      ...
      $_SESSION['error'][5]="Please enter email id";
      //header("location:staff_form.php");
...
$DOB=$_REQUEST["dob"];
   ...
   if($DOB=="")
  {
      $_SESSION['error'][6]="Please enter dob";
      //header("location:staff_form.php");
  }
...
$expension=array("jpeg","jpg","png");
   ...
   {
     $_SESSION['error'][7]="Please insert a JPEG or PNG file";
     //header("location:staff_form.php");
   }

if($file_size>4194304)
{
  $_SESSION['error'][7]="File must be exactly 2 MB";
     //header("location:staff_form.php");  
}
...
move_uploaded_file($tempname,$folder);
   ...
   if($filename=="")
  {
      $_SESSION['error'][7]="Please enter image";
      //header("location:staff_form.php");
  }
...
if(count($_SESSION['error'])>0)
{
   header("location:staff_form.php");
    ...
    $sql="insert into staff_reg(`NAME`,`USERNAME`,`PASSWORD`,`CONTACT_NO`,`EMAIL_ID`,`STAFF_ID`,`DOB`,`IMAGE`) Values ('".$NAME."','".$USER_NAME."','".$PASSWORD."','".$CONTACT_NO."','".$EMAIL_ID."','".$STAFF."','".$DOB."',' ".$folder."')";
...
if(mysqli_query($conn,$sql))
  ...
  else
  {
      ...
      {
          $_SESSION['error'][8]="username or Scholar_id already exist.";
          header("location:staff_form.php");
      }
