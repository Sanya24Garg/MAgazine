...
<head>
    <meta charset="UTF-8">
    <title>Staff_form</title>
     <link rel="stylesheet" href="css/form.css">
     <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.2/animate.min.css">
</head>
<body>
    <div class="AA animated zoomInRight">
                        <center><h1>SIGN  IN FOR STAFF</h1></center>
                               <table>
                                       <form method="post" action="staff_reg.php" enctype="multipart/form-data">
                                       <br />
                                       <br />
                                       ...
                                       <tr><td>STAFF ID :</td><td><input name="staffid" type="text" /></td></tr>
