...
else
{
     if($folder=="upload/")
         {
       $sqli=" update student_reg set NAME='".$NAME."', USERNAME='".$USER."', EMAIL_ID='".$EMAIL_ID."',CONTACT_NO='".$CONTACT_NO."',DOB='".$DOB."',SCHOLAR_ID='".$SCHOLAR_ID."'  where USERNAME='".$_SESSION['user_name']."' ";
         }
     else
         {
       $sqli=" update student_reg set NAME='".$NAME."', USERNAME='".$USER."', EMAIL_ID='".$EMAIL_ID."',CONTACT_NO='".$CONTACT_NO."',DOB='".$DOB."',SCHOLAR_ID='".$SCHOLAR_ID."',IMAGE='".$folder."'  where USERNAME='".$_SESSION['user_name']."' ";
         }
