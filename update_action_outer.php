...
else
{
        ...
        if($folder=="upload/")
         {
           $sqli=" update outsider_reg set NAME='".$NAME."', USERNAME='".$USER."', EMAIL_ID='".$EMAIL_ID."',CONTACT_NO='".$CONTACT_NO."',DOB='".$DOB ."'  where USERNAME='".$_SESSION['user_name']."' ";
         }
        else
         {
           $sqli=" update outsider_reg set NAME='".$NAME."', USERNAME='".$USER."', EMAIL_ID='".$EMAIL_ID."',CONTACT_NO='".$CONTACT_NO."',DOB='".$DOB ."',IMAGE='".$folder."'  where USERNAME='".$_SESSION['user_name']."' ";
         }
